...
from app.backend.db.db_session import get_engine_url
# Assuming your models base is here (or adjust import)
...
TEST_DB_NAME = settings.TEST_DB_NAME # Get the name from settings
