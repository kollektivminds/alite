...
def get_all_words(vocab_list_loc: str = VOCAB_LIST_LOC): #type: ignore
    # Load the JSON file
            ...
            with connection.begin():
                ...
                for command in sql_commands:
                    try:
                        ...
                        logger.error("An error was raised while executing init_db SQL commands: %s", e)
                        pass
...
def init_database():
    ...
    rand_samp = random.sample(all_words, 5)
